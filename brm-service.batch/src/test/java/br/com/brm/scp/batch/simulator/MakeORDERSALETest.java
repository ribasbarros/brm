...
public class MakeORDERSALETest extends AbstractTestNGSpringContextTests {
	...
	private static final Long QUANTIDADE_VENDAS_DIA = 1300L;
		...
		do {
			for (Collection<SkuResponseDTO> skus : map.values()) {
				for (SkuResponseDTO sku : skus) {
					if ("565e163421c6227649efd5b7".equals(sku.getId())) {
